...
<div class="modal fade" id="MyModal2<?php echo $linha['id']?>" role="dialog" aria-labelledby="mymodal" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" name="btn_excluir" id="id" onclick="f_deletar(<?php echo $linha['id']?>)">Sim, Desejo Excluir!</button>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
